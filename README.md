...
Requirements:
- This was written 100% with AutoHotkey, I have played with Autohotkey since 2010 or so. It is easy to do things efficiently and fast. This was laid out in a day. I package this with a executable, but you can also inspect the source and also run it directly from the source if you install [Autohotkey](https://www.autohotkey.com).
