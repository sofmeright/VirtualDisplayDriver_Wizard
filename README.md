...
Requirements:
- This was written 100% with AutoHotkey, I first touched Autohotkey in 2010 or so. Why AutoHotkey? I determined in evaluating how hard it would be to do this that Autohotkey would allow me to have the fastest trasition from having an idea to having a workable code. In every release there is a ".ahk" plain-text source file, that you can inspect. You can make changes and execute this code directly from the source if you wish, if you install [Autohotkey](https://www.autohotkey.com). If you do not like AutoHotkey... You are cetainly allowed to fork this and port it to something like Java or Python and I will pull the changes and build a WebUI or do something as a token of gratitude and repect for your opinion. Otherwise MAXIMUM EFFORT!!! 🥴 AutoHotkey it is! 🤣
...
Installing...
1. Unpack the exe or the script | Note: If you are using the ".ahk" plain-text source file that you will need [Autohotkey](https://www.autohotkey.com) installed to execute it directly.
