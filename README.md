...
- A quick and dirty GUI tool for manipulating Indirect Display Driver Sample (IddSample) implementations like the HDR capable ["Virtual Display Driver" from itsmikethetech](https://github.com/itsmikethetech/Virtual-Display-Driver) that works on Windows 10/11.
