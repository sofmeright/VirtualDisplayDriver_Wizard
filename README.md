...
- A quick and dirty GUI tool for manipulation (Install / Uninstall / Reload / Configure) of Indirect Display Driver Sample (IddSample) implementations like the HDR capable [Virtual Display Driver from itsmikethetech](https://github.com/itsmikethetech/Virtual-Display-Driver) that works on Windows 10/11. This a GUI based installer or configuration tool intended as a more elegant solution in place of editing configs or navigating to Device Manger.
