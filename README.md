...
To use command line arguments with the script you will need to pipe it through Autohotkey itself like such (otherwise directly after the .exe): "C:\Program Files (x86)\AutoHotkey\AutoHotkey.exe" "C:\_Staging\_Utilities\IddSampleDriver\PRPlanIT.com-VirtualDisplayDrv_Wiz.ahk" Reso_Adds 2560,1440,240
