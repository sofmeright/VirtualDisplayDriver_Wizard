...
Gui, Add, ComboBox, x+m yp W153 vBackupFileSel, Default||
LoadBackupEntries()
...
Gui, Add, ListBox, ys W153 vRenderingEngine gRenderSelTest, %VideoControllers% ; |Nvidia GeForce 1080ti ; For TESTING, add another fake gpu entry

Gui, Add, Text, xs section c00f19d, Monitors:
Gui, Add, Edit, ys W153 vMonitorCount, 
Gui, Add, UpDown, Range1-100,

Gui, Add, Text, xm c00f19d, Available Resolutions:
Gui, Add, Text, xm section c76b57e, Press F2 to set priority for the selection. Enter to submit.`nPressing DELETE will remove a entry.
